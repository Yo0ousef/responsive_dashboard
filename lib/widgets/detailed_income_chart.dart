    ...
    return PieChartData(
      ...
      sections: [
        PieChartSectionData(
          ...
          titleStyle: AppStyles.styleMedium16.copyWith(color: touchedSection == 0? Colors.black: Colors.white),
        ...
        PieChartSectionData(
          ...
          titleStyle: AppStyles.styleMedium16.copyWith(color: touchedSection == 1? Colors.black: Colors.white),
        ...
        PieChartSectionData(
          ...
          titleStyle: AppStyles.styleMedium16.copyWith(color: touchedSection == 2? Colors.black: Colors.white),
        ...
        PieChartSectionData(
          ...
          titleStyle: AppStyles.styleMedium16.copyWith(color: touchedSection == 3? Colors.black: Colors.white),
